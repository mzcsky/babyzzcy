...
- (void)commonInit
{
    ...
    
    {
        ...
        _dotView.textColor = [UIColor blackColor];
        _dotView.textAlignment = NSTextAlignmentCenter;
        _dotView.font = [UIFont systemFontOfSize:6];
...
- (void)layoutSubviews
{
    ...
    _dotView.frame = CGRectMake(0, 0, self.frame.size.width/2, self.frame.size.height/2);
    _dotView.center = CGPointMake(self.frame.size.width / 2., (self.frame.size.height / 2.) +sizeDot * 2.5 + 2);
